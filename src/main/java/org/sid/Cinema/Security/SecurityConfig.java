...
@Override
	...
	/*
	 * auth.inMemoryAuthentication().withUser("user0").password(passwordEncoder.
 ...
 @Override
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/admin/**","/add**/**","/delete**/**").hasRole("ADMIN");
		http.authorizeRequests().antMatchers("/categorie/**","/Ville/**","/cinema/**","/film/**","/projection/**","/salle/**").hasRole("USER");
		http.authorizeRequests().antMatchers("/user/**","login/","/webjar/**").permitAll();
